...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-muted/50 backdrop-blur-sm p-1 text-muted-foreground transition-all duration-300 border border-primary/10",
      className,
    )}
    {...props}
  />
